...
##  Define optimizers. 
adam  = Adam(lr=1.e-4, amsgrad=True)
nadam = Nadam(lr=1.e-4, beta_1=0.9, beta_2=0.999, epsilon=None, schedule_decay=0.004)
...
def prep_model_2D_B(nhot, optimizer=adam):
  ...
  model.add(Conv2D(32, (3, 3), activation='linear', input_shape=(128, 128, 1))) 
